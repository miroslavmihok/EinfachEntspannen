...
function Datenschutz() {
  return (
    <div className="flex items-center justify-center">
      <div className="w-full p-4 md:p-8 xl:w-[80%] 2xl:w-[50%]">
        ...
        <br />
        <p>
          R & E OG<br></br>Wienerstraße 17 2405 Bad Deutsch-AltenburgÖsterreich
        </p>
        <br />
        <p>
          E-Mail-Adresse:{" "}
          <a href="mailto:emilia.hadler@icloud.com">emilia.hadler@icloud.com</a>
        </p>
        <br />
        <p>Telefon: 06603807873</p>
        <br />
