...
function Imprint() {
  return (
    <div>
      ...
      <h2>Informationen zu E-Commerce und Mediengesetz</h2>
      <h3>R&E OG</h3>
      <p>
        Unternehmensgegenstand: Massage gem. § 94 Z 48 GewO 1994, eingeschränkt
        auf klassische Massage Betrieb eines Solariums Gewerberechtlicher
        Geschäftsführer: Emilia Hadler Kosmetik & Fußpflege Gewerberechtlicher
        Geschäftsführer: Sonja Farcher
      </p>
      <p>
        UID-Nummer: ATU77247935 Firmenbuchnummer: 563688d Firmenbuchgericht:
        Landesgericht Korneuburg Firmensitz: 2405 Bad Deutsch-Altenburg,
        Wienerstraße 17
      </p>
      <p>Tel.: 0660/3807873 E-Mail: emilia.hadler@icloud.com</p>
      <p>
        Mitglied bei: WKO, Niederösterreich, Fachgruppe: LI Fußpfleger,
        Kosmetiker und Masseure FG Freizeit- und Sportbetriebe
      </p>
      <p>
        Berufsrecht: Gewerbeordnung: www.ris.bka.gv.at
        Aufsichtsbehörde/Gewerbebehörde: Bezirkshauptmannschaft Bruck/Leitha
        Berufsbezeichnung: Kosmetiker, Fußpfleger, Masseure, Solarien
      </p>
      ...
      <p>
        ...
        betrachten, von dem aus auf diese Webseite verwiesen wurde. Sofern Teile
      ...
      <h2>Haftung für Links auf Webseiten Dritter </h2>
      <p>
        Unser Angebot enthält Links zu externen Websites. Auf den Inhalt dieser
        externen Webseiten haben wir keinerlei Einfluss. Deshalb können wir für
      ...
      <p>
        ...
        Werke auf dieser Webseite unterliegen dem Urheberrecht. Beiträge Dritter
      ...
      <p>
        Dieses Impressum gilt in gleicher Weise für die Online-Präsenzen von R&E
        OG in den folgenden sozialen Medien: Facebook und Instagram
      </p>
    </div>
  );
}
