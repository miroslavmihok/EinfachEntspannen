...
const Hero = () => {
  ...
  return (
    <div
      className="bg-fit min-h-[360px] w-full max-w-full bg-home bg-cover bg-center sm:min-h-[620px] md:min-h-[620px] xl:min-h-[980px]"
      id="home"
    >
      <div className="flex h-full min-h-[360px] w-full flex-col items-center justify-center bg-black/55 sm:min-h-[620px] xl:min-h-[980px]">
        <div className="flex h-full min-h-[360px] flex-col justify-center gap-6 p-6 text-white sm:min-h-[620px] lg:w-[50%] lg:gap-8 xl:min-h-[980px] xl:gap-10">
